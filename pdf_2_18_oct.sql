...
-- ************ perfrom the following computations on table data ************

-- a.-- select * from client_master where name like "_a%";

-- b.-- select * from client_master where city like 'm%';

-- c.-- select * from client_master where city ="banglore" or city ="delhi";

-- d.-- select * from client_master where baldue >10000;

-- e.-- select * from sales_order where order_date between "2004-06-01" and "2004-06-30";

-- f.-- select * from sales_order where client_no in("c00001","c00002");

-- g.-- select * from product_master where sellprice > 500 and sellprice<=750;

-- h.-- alter table  product_master add new_price int;

-- h.-- update product_master set new_price=(sellprice*0.15)+sellprice where sellprice>500;

-- i.-- select name,city , state from client_master where state <> "Maharashtra";

-- j.-- select count('order_no') from sales_order_details;

-- k.-- select avg(sellprice) from product_master;

-- l1.-- select max(sellprice) as"max_price" from product_master;

-- l2.-- select min(sellprice) as"min_price" from product_master;

-- m.-- select count(sellprice) from product_master where sellprice<=500 ;
